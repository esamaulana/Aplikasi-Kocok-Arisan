...
public class sSlide {
  ...
  public void jPanelXKanan(final int start, final int stop, final int delay, final int increment, final JPanel JPanel) {
  ...
  public void jPanelXKiri(final int start, final int stop, final int delay, final int increment, final JPanel JPanel) {
        if (JPanel.getX() == start) {
            new Thread() {
                public void run() {
